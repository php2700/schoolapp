  ...
  return (
    <>
      <header className="w-full shadow-md">
        <div className="bg-white text-gray-600 text-sm flex flex-col lg:flex-row justify-between items-center px-4 lg:px-6 py-3 border-b border-[#DDDDDD] gap-3 lg:gap-0">
          <div className="flex flex-wrap items-center gap-3 lg:gap-5 justify-center lg:justify-start">
            <span className="flex items-center gap-1">
              <FaPhoneAlt className="text-[#474747]" />
              <span className="font-medium text-sm lg:text-[16px] text-[#474747]">
                +91-9878787825
              </span>
            </span>
            ...
            <div className="flex gap-2">
              <img src={Instagram} alt="Instagram" className="h-6 lg:h-7" />
              <img src={Facebook} alt="Facebook" className="h-6 lg:h-7" />
              <img src={Whatsapps} alt="Whatsapp" className="h-6 lg:h-7" />
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-3 lg:gap-14 justify-center lg:justify-end">
            <img src={Shriram} alt="Shriram" className="h-6 lg:h-8" />
            <img src={Enducare} alt="Enducare" className="h-6 lg:h-8" />
            <img src={Theshri} alt="Theshri" className="h-6 lg:h-8" />
          </div>
        </div>

        <nav className="bg-white flex items-center justify-between px-4 lg:px-8 py-4 relative z-30">
          ...
          <ul
            className={`lg:flex gap-6 xl:gap-18 text-gray-700 font-medium items-center absolute lg:static bg-white lg:bg-transparent w-full lg:w-auto left-0 lg:left-auto top-full lg:top-auto transition-all duration-300 ${isOpen ? "max-h-screen py-4 overflow-y-auto" : "max-h-0 overflow-hidden"
              } lg:max-h-full lg:overflow-visible flex-col lg:flex-row`}
          >
            <li
              className="relative px-4 lg:px-0 py-2 lg:py-0"
            ...
            >
              ...
              <ul
                className={`lg:absolute bg-[#25337C] mt-2 lg:mt-0 lg:w-64 overflow-hidden transition-all duration-300 z-50 ${
                  activeDropdown === "about"
                    ? "max-h-96 opacity-100 py-2 lg:max-h-fit lg:opacity-100"
            ...
            <li className="px-4 lg:px-0 py-2 lg:py-0 hover:text-blue-600 cursor-pointer">
            ...
            >
              <button
                ...
                className="flex items-center gap-2 hover:text-blue-600 cursor-pointer w-full text-left lg:w-auto"
              >
            ...
            <li className="px-4 lg:px-0 py-2 lg:py-0">
              <Link
                to="/contact-us"
                onClick={handleLinkClick}
                className="bg-blue-800 text-white px-4 lg:px-6 py-2 rounded-lg font-semibold hover:bg-blue-900 w-full lg:w-auto inline-block text-center cursor-pointer"
              >
                Contact us
              </Link>
            </li>
