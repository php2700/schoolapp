...
//   const [isOpen, setIsOpen] = useState(false);
//   const [isAboutDropdownOpen, setIsAboutDropdownOpen] = useState(false); // State for About Us dropdown
//   const [isShriWayDropdownOpen, setIsShriWayDropdownOpen] = useState(false); // State for The Shri Way dropdown
//   const [isLearningDropdownOpen, setIsLearningDropdownOpen] = useState(false); // State for Learning dropdown


//   // Function to close all dropdowns when main nav is toggled
//   const toggleMainMenu = () => {
//     setIsOpen(!isOpen);
//     setIsAboutDropdownOpen(false);
//     setIsShriWayDropdownOpen(false);
...
//             <button onClick={toggleMainMenu}> {/* Use the new toggle function */}
//               {isOpen ? (
...
//           {/* Links */}
//           <ul
//             className={`md:flex gap-6 lg:gap-18 text-gray-700 font-medium items-center 
// absolute md:static bg-white md:bg-transparent w-full md:w-auto 
// left-0 md:left-auto top-full md:top-auto transition-all duration-300 
// ${isOpen ?  "max-h-screen py-4 overflow-y-auto" : "max-h-0 overflow-hidden"} 
// md:max-h-full md:overflow-visible flex-col md:flex-row`}
//           >
//             {/* About Us Dropdown */}
//             <li className="relative px-4 md:px-0 py-2 md:py-0">
//               <button
...
//               </button>
//               <ul
//                 className={`md:absolute md:bg-white md:shadow-lg md:rounded-md mt-2 md:mt-0 md:w-56 overflow-hidden transition-all duration-300 ${isAboutDropdownOpen ? 'max-h-96 opacity-100 py-2' : 'max-h-0 opacity-0'} md:max-h-fit md:opacity-100`}
//               >
//                 <li>
//                   <Link
//                     to="/about/tsus-ludhiana"
//                     onClick={() => { setIsOpen(false); setIsAboutDropdownOpen(false); }} // Close nav and dropdown on click
...
//                     onClick={() => { setIsOpen(false); setIsAboutDropdownOpen(false); }}
//                     className="block px-4 py-2 hover:bg-gray-100 text-gray-700 md:text-blue-900"
//                   >
//                     The Leadership Team
//                   </Link>
...
//             {/* The Shri Way Dropdown (Example - apply similar structure) */}
//             <li className="relative px-4 md:px-0 py-2 md:py-0">
//               <button
//                 onClick={() => setIsShriWayDropdownOpen(!isShriWayDropdownOpen)}
//                 className="flex items-center gap-2 hover:text-blue-600 cursor-pointer w-full text-left"
//               >
//                 The Shri Way <img src={Arrow} alt="dropdown icon" className={`w-2 h-2 transition-transform ${isShriWayDropdownOpen ? 'rotate-180' : ''}`} />
//               </button>
//               <ul
//                 className={`md:absolute md:bg-white md:shadow-lg md:rounded-md mt-2 md:mt-0 md:w-56 overflow-hidden transition-all duration-300 ${isShriWayDropdownOpen ? 'max-h-96 opacity-100 py-2' : 'max-h-0 opacity-0'} md:max-h-fit md:opacity-100`}
//               >
//                 <li>
//                   <Link
//                     to="/shriWay/philosophy"
//                     onClick={() => { setIsOpen(false); setIsShriWayDropdownOpen(false); }}
//                     className="block px-4 py-2 hover:bg-gray-100 text-gray-700 md:text-blue-900"
//                   >
//                     Our Philosophy
//                   </Link>
...
//                   </Link>
//                 </li>
//                 {/* Add more Shri Way links here */}
//               </ul>
//             </li>

//             {/* Learning Dropdown (Example - apply similar structure) */}
//             <li className="relative px-4 md:px-0 py-2 md:py-0">
//               <button
//                 onClick={() => setIsLearningDropdownOpen(!isLearningDropdownOpen)}
//                 className="flex items-center gap-2 hover:text-blue-600 cursor-pointer w-full text-left"
//               >
//                 Learning <img src={Arrow} alt="dropdown icon" className={`w-2 h-2 transition-transform ${isLearningDropdownOpen ? 'rotate-180' : ''}`} />
//               </button>
//               <ul
//                 className={`md:absolute md:bg-white md:shadow-lg md:rounded-md mt-2 md:mt-0 md:w-56 overflow-hidden transition-all duration-300 ${isLearningDropdownOpen ? 'max-h-96 opacity-100 py-2' : 'max-h-0 opacity-0'} md:max-h-fit md:opacity-100`}
//               >
//                 <li>
//                   <Link
//                     to="/learning/curriculum"
//                     onClick={() => { setIsOpen(false); setIsLearningDropdownOpen(false); }}
//                     className="block px-4 py-2 hover:bg-gray-100 text-gray-700 md:text-blue-900"
//                   >
//                     Curriculum
//                   </Link>
...
//                   </Link>
//                 </li>
//                 {/* Add more Learning links here */}
//               </ul>
//             </li>

//             {/* Facilities, Admission, Gallery, Contact Us - no dropdown for now */}
...
//               <Link to="/admission" onClick={() => setIsOpen(false)} className="flex items-center gap-2">
//                 Admission <img src={Arrow} alt="dropdown icon" className="w-2 h-2" />
//               </Link>
//               {/* You can add a dropdown here for Admission similarly */}
//             </li>
//             <li className="px-4 md:px-0 py-2 md:py-0 hover:text-blue-600 cursor-pointer">
