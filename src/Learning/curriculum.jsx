...
export default function Curriculum() {
  ...
  const getPursuitData = async () => {
    axios
      .get(`${import.meta.env.VITE_APP_URL}api/user/pursuit`)
      .then((res) => {
        setPursuitData(res?.data?.data);
      })
      .catch((error) => {
        setError(
