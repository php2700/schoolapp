...
const navigate=useNavigate()
  ...
  const getArtData = async () => {
    axios
      .get(`${import.meta.env.VITE_APP_URL}api/user/art`)
      .then((res) => {
  ...
  const handleUrl=(url)=>{
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Hero Section */}
            <section className="relative h-120 bg-cover bg-center  rounded-bl-[45px] rounded-br-[45px] overflow-hidden" style={{ backgroundImage: `url(${import.meta.env.VITE_APP_URL}${artData?.banner})` }}>
            ...
            <div className=" bg-white container mx-auto py-12 px-4 md:flex">
                ...
                <aside className="w-full md:w-1/4 pr-8 mb-8 md:mb-0">
                   ...
                   [box-shadow:0_2px_6px_2px_rgba(60,64,67,0.15),0_1px_2px_0_rgba(60,64,67,0.30)]">
                        ...
                        <ul>
                            <li className="mb-2">
                                <div onClick={()=>handleUrl('/learning/Art')} className="flex items-center justify-between py-2 px-3 rounded-md   bg-[#25337C] text-white">
                                    Art and Visual Art
                                    <img
                            ...
                            <li className="mb-2">
                                <div onClick={()=>handleUrl('/learning/Classroom')} className="flex items-center justify-between py-2 px-3 rounded-md hover:bg-gray-200 text-[#737373] ">
                    ...
                    <div className="mb-8 text-[#333333]  text-[18px] tracking-normal text-center font-['poppins'] font-medium">
                        {
                            ...
                            artData?.description?.map((ele)=>(
                                <p className="mb-12">{ele}</p>
                            ))
}
