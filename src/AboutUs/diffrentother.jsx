            ...
            <section className="relative h-120 bg-cover bg-center  rounded-bl-[45px] rounded-br-[45px] overflow-hidden" style={{ backgroundImage: `url(${import.meta.env.VITE_APP_URL}${diffrentFromData?.image})` }}>
                ...
                <div className=" font-['poppins'] relative z-10 flex flex-col items-center justify-center h-full text-white">
                    ...
                    <div className="flex items-center text-lg mt-2">
                        ...
                        <span className='text-[#F3D805]'>What makes us different from others</span>
                    </div>
                </div>
            </section>
            ...
            <div className=" bg-white container mx-auto py-12 px-4 md:flex">
                ...
                <aside className="w-full md:w-1/4 pr-8 mb-8 md:mb-0">
                   ...
                   [box-shadow:0_2px_6px_2px_rgba(60,64,67,0.15),0_1px_2px_0_rgba(60,64,67,0.30)]">
                        ...
                        <ul>
                            <li className="mb-2">
                                 <div onClick={()=>handleUrl('/about/tsus-ludhiana')} className="flex items-center justify-between py-2 px-3 rounded-md  hover:bg-gray-200  text-[#737373]">
                                    About TSUS Ludhiana
                                    <img
                            ...
                            <li>
                                <div onClick={()=>handleUrl('/about/what-makes-us-different')} className="flex items-center justify-between py-2 px-3 rounded-md bg-[#25337C] text-white">
                                    What makes us different from others
                                    <img
                                        src={ChevronRightIcon}   // apna icon ka path yaha lagao
                                        alt="chevron right"
                ...
                <main className="w-full max-w-6xl mx-auto px-4 py-8 bg-white text-center
                   ...
                   [box-shadow:0_2px_6px_2px_rgba(60,64,67,0.15),0_1px_2px_0_rgba(60,64,67,0.30)]">
                    {/* <h2 className="font-['poppins'] font-semibold text-[24px] leading-tight text-[#25337C] mb-6 mt-6">Mission</h2> */}
