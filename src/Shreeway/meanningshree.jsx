            ...
            <div className="bg-white min-h-screen">
                ...
                <section className="relative h-100 bg-cover bg-center  rounded-bl-[45px] rounded-br-[45px] overflow-hidden" style={{ backgroundImage: `url(${BannerImage})` }}>
                    ...
                    <div className=" font-['poppins'] relative z-10 flex flex-col items-center justify-center h-full text-white">
                        <h1 className="font-['poppins'] font-semibold text-[55px] leading-tight text-white">Meaning of "SHRI"</h1>
                ...
                <div className="container mx-auto py-12 px-4 md:flex">
                 ...
                 [box-shadow:0_2px_6px_2px_rgba(60,64,67,0.15),0_1px_2px_0_rgba(60,64,67,0.30)]">
                            <h3 className=" font-['poppins'] text-xl font-semibold text-[#25337C] mb-4">The Shri Way</h3>
                            <ul>
                                <li className="mb-2">
                 ...
                 [box-shadow:0_2px_6px_2px_rgba(60,64,67,0.15),0_1px_2px_0_rgba(60,64,67,0.30)]">
                        <h2 className="font-['poppins'] font-semibold text-[55px] leading-tight text-[#25337C] mb-6 mt-6">Meaning of "SHRI"</h2>

                        {/* Hindi Content */}
                        <div className="mb-8 text-[#333333]  text-[18px] tracking-normal text-center font-['poppins'] font-medium">
                            <p className="mb-4">
                                “श्री” शब्द के उस छोटे से रूप के अनेकानेक अर्थ हैं। <br /> अधिकांशतः मंत्रों के उच्चारण में इस पवित्र शब्द का प्रयोग किया जाता है। <br /> “श्री” का शाब्दिक अर्थ है समृद्धि
                            </p>
                            {/* <p className="mb-4 font-semibold">
            “श्री” का शाब्दिक अर्थ है समृद्धि
        </p> */}
                            <p className="mb-4">
                                समृद्धि ही - उत्तम विद्यार्थी भवाे की, किसी कार्य की, सफलता की। <br />
                                समृद्धि ही - सुनिमत की, कुशलता की, सत्यवाटी व मनलविषस की। <br />
                                समृद्धि ही – ऐसे विशस की जो तुम्हाट अन्तट की अनिखयी नवानि धनवालिव कर सको <br />
                                जिससे आपका दृष्टो तत्व ज्ञान से प्रकधित हो औट <br />
                                आप अपने जीवन की लाविश बना सको।
                            </p>
                        </div>

                        <hr className="my-4 border-blue-200 w-3/4 mx-auto border-dotted " /> {/* Divider line */}

                        {/* English Content */}
                        <div className="mb-8 text-[#333333]  text-[18px] tracking-normal text-center font-['poppins'] font-regular">
                            <p className="mb-4">
                                The word "SHRI" has multiple and expanded connotations.<br />
                                This auspicious prefix is added to various mantras.Its literal meaning is Wealth – of virtue or excellence.<br />
